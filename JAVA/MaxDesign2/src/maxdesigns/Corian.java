 ...
 * @author DEll
 */
public class Corian extends javax.swing.JInternalFrame {

    public int index = -1;
    
    public String data = "";
    /**
     * Creates new form Corian
     */
    public Corian() {
        initComponents();
    ...
    public String FullData()
    {
        ...
        s += "                         Corian / Marble / Granite Fitter\n"; //*****************************************************************
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Corian / Marble / Granite Fitter");
    ...
    private void recBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recBtnActionPerformed
        ...
        else
        {
            if(MaxDesigns.getInstance().getCon().get(index).isDigits(amount))
            {
                ...
                fdata += "Corian / Marble / Granite Fitter Amount : "+a+"\n";   //***********************************************************
                data += "Corian / Marble / Granite Fitter Amount Details are as follows\n\n"; //********************************************
                data += details+"\n\n";
                fdata += "Details of the Corian / Marble / Granite Fitter are as follows :\n\n";//********************************************
                fdata += details +"\n";
                DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
                LocalDateTime now = LocalDateTime.now();
