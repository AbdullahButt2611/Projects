 ...
 * @author DEll
 */
public class CivilLabor extends javax.swing.JInternalFrame {
    ...
    private void recBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recBtnActionPerformed
        ...
        else
        {
            if(MaxDesigns.getInstance().getCon().get(index).isDigits(amount))
            {
                ...
                fdata += "Civil Labour Amount : "+a+"\n";   //***********************************************************
                data += "Civil Labour Amount Details are as follows\n\n"; //********************************************
                data += details+"\n\n";
                fdata += "Details of the Civil Labor are as follows :\n\n";//********************************************
                fdata += details +"\n";
                DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
                LocalDateTime now = LocalDateTime.now();
