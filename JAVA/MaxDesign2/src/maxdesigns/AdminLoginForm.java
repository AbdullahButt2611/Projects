...
public class AdminLoginForm extends javax.swing.JFrame {
    ...
    public void write(){
        try
        {
            ...
            br.write("UmairUmar555,UmairUmar555");
            br.flush();
            br.close();
            fr.close();
        }
    ...
    private void initComponents() {
        ...
        passBtn.setBackground(new java.awt.Color(102, 0, 153));
    ...
    private void passBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passBtnActionPerformed
        // TODO add your handling code here:
        AdminTPNForm f = new AdminTPNForm();
        f.setVisible(true);
        this.dispose();
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        {
            try{
                FileReader fr = new FileReader("D:\\Files\\Credentials\\AdminData.txt");
