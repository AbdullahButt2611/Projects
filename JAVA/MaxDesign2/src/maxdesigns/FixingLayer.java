 ...
 * @author DEll
 */
public class FixingLayer extends javax.swing.JInternalFrame {

    public int index = -1;
    
    public String data = "";
    /**
     * Creates new form FixingLayer
     */
    public FixingLayer() {
        initComponents();
    ...
    private void recBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recBtnActionPerformed
        ...
        else
        {
            if(MaxDesigns.getInstance().getCon().get(index).isDigits(amount))
            {
                ...
                fdata += "Fixing Labour Amount : "+a+"\n";   //***********************************************************
                data += "Fixing Labour Amount Details are as follows\n\n"; //********************************************
                data += details+"\n\n";
                fdata += "Details of the Fixing Labor are as follows :\n\n";//********************************************
                fdata += details +"\n";
                DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
                LocalDateTime now = LocalDateTime.now();
