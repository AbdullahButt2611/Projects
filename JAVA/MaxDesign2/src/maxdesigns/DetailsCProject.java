 ...
 * @author DEll
 */
public class DetailsCProject extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form DetailsCProject
     */
    public DetailsCProject() {
        initComponents();
    ...
    public String fileData()
    {
        String s = "\n\n*****************************************************************************\n";
               ...
               s += "Project Amount Decided : "+ MaxDesigns.getInstance().getCon().get(index).getAmount()+"\n";
               s += "Balance Before Transaction : "+ MaxDesigns.getInstance().getCon().get(index).getBalance()+"\n";
               return s;
    }
    ...
    private void recBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recBtnActionPerformed
        ...
        else
        {
            if(MaxDesigns.getInstance().getCon().get(index).isDigits(amount))
            {
                ...
                int b = MaxDesigns.getInstance().getCon().get(index).getBalance();
                a = b-a;
                
                MaxDesigns.getInstance().getCon().get(index).setBalance(a);
                data += "Balance After Transaction will be : "+ MaxDesigns.getInstance().getCon().get(index).getBalance()+"\n\n";
