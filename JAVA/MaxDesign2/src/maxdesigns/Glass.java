 ...
 * @author DEll
 */
public class Glass extends javax.swing.JInternalFrame {

    public int index = -1;
    
    public String data = "";
    /**
     * Creates new form Glass
     */
    public Glass() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Glass / Aluminium");
    ...
    private void recBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recBtnActionPerformed
        ...
        else
        {
            if(MaxDesigns.getInstance().getCon().get(index).isDigits(amount))
            {
                ...
                fdata += "Glass / Aluminium Amount : "+a+"\n";   //***********************************************************
                data += "Glass / Aluminium Amount Details are as follows\n\n"; //********************************************
                data += details+"\n\n";
                fdata += "Details of the Glass / Aluminium are as follows :\n\n";//********************************************
                fdata += details +"\n";
                DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
                LocalDateTime now = LocalDateTime.now();
