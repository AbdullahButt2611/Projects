...
public class Wallpaper extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WallPaper Fiting");
    ...
    private void recBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recBtnActionPerformed
        ...
        else
        {
            if(MaxDesigns.getInstance().getCon().get(index).isDigits(amount))
            {
                ...
                fdata += "Wallpaper Fiting Amount : "+a+"\n";   //***********************************************************
                data += "Wallpaper Fiting Amount Details are as follows\n\n"; //********************************************
                data += details+"\n\n";
                fdata += "Details of the Wallpaper Fiting are as follows :\n\n";//********************************************
                fdata += details +"\n";
                DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
                LocalDateTime now = LocalDateTime.now();
