 ...
 * @author DEll
 */
public class EmpLoginForm extends javax.swing.JFrame {

    /**
     * Creates new form EmpLoginForm
     */
    public EmpLoginForm() {
        initComponents();
//        write();
    ...
    public void write(){
        try
        {
            FileWriter fr = new FileWriter("C:\\Users\\DEll\\Desktop\\Waste\\Test\\Pange\\MaxDesigns\\Credentials\\EmpData.txt");
            BufferedWriter br = new BufferedWriter(fr);
            br.write("Username     ,      Password\n");
            br.write("Employee555,Ayesha555");
            br.flush();
            br.close();
            fr.close();
        }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1138, 792));
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        {
            try{
                FileReader fr = new FileReader("D:\\Files\\Credentials\\EmpData.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpLoginForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpLoginForm().setVisible(true);
            }
        });
    }
