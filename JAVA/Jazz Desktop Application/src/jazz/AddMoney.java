...
/**
 *This is a form that will help the Admin to add money in the user Account
 * This is a the form which the shopkeeper or jazz account admin holder will use when the user get the money in cash and will send the 
 * digital currency in the user Account.
 * @version 1.0
 * @author 2020-CS-72
 * @author 2020-CS-63
 */
public class AddMoney extends javax.swing.JFrame {
    ...
    /**
     * This is the variable to store the index of the person in whose account  money needs to be deposited
     */
    int index = -1;
    
    /**
     * This will store the contact number in whose account the money is going to be deposited
     */
    String contact="";
