...
/**
 *This is a form that will be called whenever the system needs to visit the JazzCash Menu that has been specifically made for the Admin.
 * It includes all the buttons and options that are available for the admin on the JazzCash side to work 
 * @author DEll
 */
