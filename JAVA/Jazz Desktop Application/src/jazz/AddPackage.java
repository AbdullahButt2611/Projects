...
/**
 *This is the form that will be called when the admin wants to add a new package into the system that needs to be displayed.
 * For it the admin has to enter the details of the admin correctly Once it gets validated the data will added in the list
 * @author 2020-CS-63
 * @author 2020-CS-72
 * @version 1.0
 */
public class AddPackage extends javax.swing.JFrame {
     ...
     * It will also call the method that will change the table's physical appearance
     */
    public AddPackage() {
        initComponents();
        SetTable();
    ...
    /**
     * This is method that will help to change the physical appearance of the table. Actually it will transform the table into
     * invisible table with the borders and headings only.
     */
    ...
    /**
     * This is a method that will be called when the system wants to add Data in the table. It means whenever there is a need to
     * display data in the table this method will be called.
     * 
     */
